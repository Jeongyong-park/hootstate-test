...
function InnoNavVerticalGroup(props) {
...
InnoNavVerticalGroup.propTypes = {
...
InnoNavVerticalGroup.defaultProps = {};

const NavVerticalGroup = withRouter(React.memo(InnoNavVerticalGroup));
