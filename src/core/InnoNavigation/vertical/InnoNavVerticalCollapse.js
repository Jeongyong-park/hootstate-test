...
import InnoNavItem from '../InnoNavItem';
...
function InnoNavVerticalCollapse(props) {
	...
	return (
		<ul className={clsx(classes.root, open && 'open')}>
			...
			>
				...
				{item.badge && <InnoNavBadge className="mx-4" badge={item.badge} />}
...
InnoNavVerticalCollapse.propTypes = {
...
InnoNavVerticalCollapse.defaultProps = {};

const NavVerticalCollapse = withRouter(React.memo(InnoNavVerticalCollapse));
