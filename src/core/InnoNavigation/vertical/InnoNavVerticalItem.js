...
function InnoNavVerticalItem(props) {
    ...
    return (
        ...
        >
            ...
            {item.badge && <InnoNavBadge badge={item.badge} />}
        </ListItem>
    );
}

InnoNavVerticalItem.propTypes = {
...
InnoNavVerticalItem.defaultProps = {};

const NavVerticalItem = withRouter(React.memo(InnoNavVerticalItem));
